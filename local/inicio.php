...
session_start();
include_once("../controlador/enrutadorLocal.php");
$objEnrutador=new enrutadorLocal();
if ($_GET["cargar"]=="cerrarSesion") {
  unset($_SESSION['usuarioLogin']);
}
if ($objEnrutador->validarVista($_GET['cargar'])) {
  if (!isset($_SESSION['usuarioLogin'])) {
    header('Location:http://localhost/proyectoPsicosocial1/local/');
  }else{
    ?>
...
<div class="container-fluid mh-100">
  ...
  <div class="row d-flex d-md-block flex-nowrap wrapper" >
    <div class="col-md-3 float-left col-1 pl-0 pr-0 collapse width show " id="sidebar" >
      <nav class="col-md-12 d-none d-md-block bg-light sidebar " style="height: 100%">
