		...
		public function arrEmpresa($id){
			...
			if (mysqli_num_rows($result)) {
				while ($obj=mysqli_fetch_assoc($result)) {
					$arrEmpresa[0]=array('nit_empresa'=>$obj['nit_empresa'], 'nombre_empresa'=>utf8_encode($obj['nombre_empresa']), 'ciudad_empresa'=>$obj['ciudad_empresa'], 'direccion_empresa'=>$obj['direccion_empresa'], 'telefono_empresa'=>$obj['telefono_empresa'], 'contacto_empresa'=>utf8_encode($obj['contacto_empresa']), 'estado_empresa'=>$obj['estado_empresa']);
				}
				return $arrEmpresa;
			}
		}
